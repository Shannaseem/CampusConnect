document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        try {
            ...
            document.getElementById('stat-attendance').textContent = `${attPercentage}%`;
            document.getElementById('bar-attendance').style.width = `${attPercentage}%`;
            document.getElementById('stat-subjects').textContent = studentReport.subjects_enrolled;
            ...
            if (studentReport.subject_details.length === 0) {
                subjectBody.innerHTML = '<tr><td colspan="4">No enrolled subjects.</td></tr>';
            } else {
            ...
            document.getElementById('subject-analytics-body').innerHTML = '<tr><td colspan="4" style="color:red;">Error loading analytics</td></tr>';
        }
        ...
        if (assignmentsList) {
            try {
                ...
                document.getElementById('stat-assignments-due').textContent = newAssignments.length;
                ...
                if (newAssignments.length === 0) {
                    assignmentsList.innerHTML = '<p style="color: var(--text-muted); padding: 1rem;">No pending assignments.</p>';
                } else {
                ...
                assignmentsList.innerHTML = '<p style="color: #ef4444; padding: 1rem;">Error loading assignments.</p>';
            }
        }
